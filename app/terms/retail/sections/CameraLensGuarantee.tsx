...
const CameraLensGuarantee = () => {
  return (
    <>
      {/* Camera Lens Guarantee - Start */}
      <section className="space-y-4 mt-8">

        {/* Camera Lens Guarantee Header - Start */}
        <div className="font-bold">
          <h2 className="text-xl text-green-primary1">Camera Lens Guarantee</h2>
          <p>Eligible Device: Mobile Phones</p>
          <p>Product: Tempered Glass Protection</p>
        </div>
        {/* Camera Lens Guarantee Header - End */}

        {/* Camera Lens Guarantee Content - Start */}
        <p>
        ...
        <p>
          Camera protection coverage is subject to the maximum coverage amount specified on your Product&#39;s packaging and only if the purchased Product is properly applied. instaProtek will not be liable for any indirect or incidental damages arising from the use of this Product.
        </p>
        <p>
        ...
        {/* Camera Lens Guarantee Content - End */}
      </section>
      {/* Camera Lens Guarantee - End */}
    </>
  );
};

export default CameraLensGuarantee;